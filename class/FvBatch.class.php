...
class FvBatch extends CommonObject
{
    ...
    public $fields = array(
        ...
        'fk_certificate' => array('type' => 'integer', 'label' => 'Certificate', 'enabled' => 1, 'visible' => 0, 'position' => 17, 'foreignkey' => 'fv_certificate.rowid'),
        'fk_focus_job' => array('type' => 'integer', 'label' => 'FocusJob', 'enabled' => 1, 'visible' => 0, 'position' => 18, 'foreignkey' => 'fv_focus_job.rowid'),
