...
/**
 * Batch export request representation.
 */
class FvBatchExport extends CommonObject
{
    /** @var string */
    public $element = 'fvbatchexport';

    /** @var string */
    public $table_element = 'fv_batch_export';
    ...
    public $fields = array(
        ...
        'export_type' => array('type' => 'varchar(32)', 'label' => 'ExportType', 'enabled' => 1, 'visible' => 1, 'position' => 20),
        'requested_at' => array('type' => 'datetime', 'label' => 'DateRequest', 'enabled' => 1, 'visible' => 1, 'position' => 25),
        'processed_at' => array('type' => 'datetime', 'label' => 'DateProcessed', 'enabled' => 1, 'visible' => 1, 'position' => 30),
        'file_path' => array('type' => 'varchar(255)', 'label' => 'FilePath', 'enabled' => 1, 'visible' => 1, 'position' => 35),
        'payload_json' => array('type' => 'text', 'label' => 'PayloadJson', 'enabled' => 1, 'visible' => 0, 'position' => 40),
