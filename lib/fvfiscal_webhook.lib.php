...
class FvFiscalWebhookProcessor
{
    ...
    private $statusMap = array(
        'queued' => FvNfeOut::STATUS_DRAFT,
        'pending' => FvNfeOut::STATUS_DRAFT,
        'waiting' => FvNfeOut::STATUS_DRAFT,
        'scheduled' => FvNfeOut::STATUS_DRAFT,
        'processing' => FvNfeOut::STATUS_PROCESSING,
        'running' => FvNfeOut::STATUS_PROCESSING,
        'executing' => FvNfeOut::STATUS_PROCESSING,
        'finished' => FvNfeOut::STATUS_AUTHORIZED,
        'completed' => FvNfeOut::STATUS_AUTHORIZED,
        'concluded' => FvNfeOut::STATUS_AUTHORIZED,
        'success' => FvNfeOut::STATUS_AUTHORIZED,
        'authorized' => FvNfeOut::STATUS_AUTHORIZED,
        'autorizado' => FvNfeOut::STATUS_AUTHORIZED,
        'ok' => FvNfeOut::STATUS_AUTHORIZED,
        'failed' => FvNfeOut::STATUS_ERROR,
        'error' => FvNfeOut::STATUS_ERROR,
        'denied' => FvNfeOut::STATUS_ERROR,
        'rejected' => FvNfeOut::STATUS_ERROR,
        'cancelled' => FvNfeOut::STATUS_CANCELLED,
        'canceled' => FvNfeOut::STATUS_CANCELLED,
    );
